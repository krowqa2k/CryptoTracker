    ...
    private func addSubscribers() {
        coinDetailService.$coinDetails
            ...
            .map({ (coinDetailModel, coinModel) -> (overview: [StatisticModel], additional: [StatisticModel]) in
                ...
                let overviewAray: [StatisticModel] = [
                ...
                let marketCapChangeStat = StatisticModel(title: "24h Market Cap Change", value: marketCapChange2, percentageChange: marketCapPercentageChange2)
                
                let additionalArray: [StatisticModel] = [
                    highStat, lowStat, priceChangeStat, marketCapChangeStat
                ]
                
                return (overviewAray,additionalArray)
            })
